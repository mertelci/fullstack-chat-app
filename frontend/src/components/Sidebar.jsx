            ...
            <div className="border-b border-base-300 w-full p-5">
                ...
                <div className="mt-3 hidden lg:flex items-center gap-2">
                    <label className="cursor-pointer flex items-center gap-2 mt-3">
                        ...
                        />
                        <span className="text-xs font-normal">Online Users</span>
                        <span className="text-xs text-zinc-500 font-light">({onlineUsers.length - 1})</span>
                    </label>
              ...
              `}
                    ...
                    rounded-full ring-2 ring-zinc-900"
                        ...
                        <div className="hidden lg:block text-left min-w-0">
                            <div className="font-normal truncate">{user.fullName}</div>
